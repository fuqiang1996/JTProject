...
public class UserController {
	...
	@ResponseBody
	public Object queryUserData(@PathVariable String _ticket,String callback){
		try {
			String jsonUser = userService.queryUserData(_ticket);
			MappingJacksonValue jacksonValue = new MappingJacksonValue(SysResult.oK(jsonUser));
			jacksonValue.setJsonpFunction(callback);
			return jacksonValue;
		} catch (Exception e) {
			e.printStackTrace();
